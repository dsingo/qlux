...
.z.m.int_app: {[routes]
  ...
  .z.m.int_router select page: ('[;]/) routes[`page] first traversal, first rtype by path: "/" sv/: string routes[`name] @ traversal from routes where rtype in `index`matching`static
  };
